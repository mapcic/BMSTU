...
function [outputs] = showResult(dx, HS, Ec1, Ec2, Ec3, Ec4, J1, J2, J3, J4, Tr1, Tr2, Tr3, Tr4, dU, b)
	...
	plotFormat( Axes{5}, ...
		'Transperent of RTHS',...
		'$\ln T(E)$', 'Energy, eV', ...
		strcat(lF(1:4), strread(num2str(b),'%s'), lL(1:4)), ...
		[], [min(Ec4), max(Ec1)], ...
		18 ...
	);
	...
	plotFormat( Axes{2}, ...
		strcat('Current density') , ...
		'$dU$, V', '$J$, A/m$^{-2}$',...
		strcat(lF(3:4), strread(num2str(b(3:4)),'%s'), lL(3:4)), ...
		[], [], ...
		18 ...
	);
